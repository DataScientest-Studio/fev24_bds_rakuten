...
st.write(
    ...
    "2. > Construction de modèles spécifiques pour les classes les moins bien prédites (ie : 2583 - Piscines & Accessoires F1-Score=0.78) et integration de ces modèles au Voting / Stacking Classifier.\n"
...
st.write(
    "1. > Globalement, notre modèle final nous semble avoir une performance acceptable pour des équipes métier. 6% d'erreurs peut être de manière réaliste géré opérationnellement sans pénaliser fortement les ressources humaines.\n"
